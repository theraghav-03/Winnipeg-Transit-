...
lon = -97.197585 # GPS longitude of my home
lat = 49.936993  # GPS latitude of my home
...
if stop_number in stops_dict:
    ...
    print("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-")
    print(f"Schedule for stop:{Fore.YELLOW}{stop_number}{Fore.RESET}-stop_info:::")
